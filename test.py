        ...
        for si, pred in enumerate(out):
            ...
            if nl:
                ...
                for cls in torch.unique(tcls_tensor):
                    ...
                    pi = (cls == pred[:, -1]).nonzero(as_tuple=False).view(-1)  # target indices
            ...
            stats.append((correct.cpu(), pred[:, 4].cpu(), pred[:, -1].cpu(), tcls))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/exp73/weights/last.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='data/pet.yaml', help='*.data path')
